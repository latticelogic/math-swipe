    ...
    return (
        <>
            <motion.div
                ...
                className="mt-3 mb-2 px-3 py-2 rounded-xl border border-[var(--color-gold)]/25 bg-[var(--color-gold)]/8 flex items-center gap-2.5"
            >
                {/* Same hand-drawn download glyph as the pill */}
                <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="text-[var(--color-gold)] shrink-0">
                    <path d="M12 3 L 12 15" />
                    <path d="M7 10 L 12 15 L 17 10" />
                    <path d="M5 19 L 19 19" />
                </svg>
