...
export const COACH_PI: Teacher = {
    ...
    // Coach Pi's voice: drill instructor with a heart. Short clipped lines,
    // never cruel. Praises form and pacing, not just answers. Distinct from
    // Pixel (gamer cool) by being physical-coach urgent.
    voice: {
        idle: [
            'On your mark.',
            'Eyes up. Hands ready.',
        ...
        fail: [
            ...
            'Doesn\'t count. Once more.',
            'Breathe. Then go.',
        ],
        streak: [
            'In the zone — stay there.',
            'Don\'t look down.',
            'Pace is perfect.',
